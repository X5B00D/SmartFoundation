...
namespace SmartFoundation.Mvc.Controllers.ElectronicBillSystem
{
    ...
    {
        public async Task<IActionResult> AllMeterRead()
        {
            ...
            var dsModel = new SmartTableDsModel
            {
                ...
                Searchable = true,
                AllowExport = true,
                PageTitle = "قراءة العدادت الدورية",
                PanelTitle = "قراءة العدادت الدورية",
                EnableCellCopy = true,
                RenderAsToggle = true,
                ToggleLabel = "الفترات النشطة",
                ...
                Toolbar = new TableToolbarConfig
                {
                    ...
                    ShowDelete = canCLOSEMETERREADPERIOD && closeperiod,
                    ShowAdd = canCLOSEMETERREADPERIOD && openperiod,
                    ShowBulkDelete = false,


                    Add = new TableAction
                    {
                        Label = "فتح فترة قراءة عدادات دورية",
                        Icon = "fa fa-check",
                        Color = "success",
                    ...
                    {
                        Label = "اغلاق فترة قراءة عدادات دورية",
                        Icon = "fa fa-xmark",
                        Color = "danger",
                       // Placement = TableActionPlacement.ActionsMenu, //   أي زر بعد ما نسويه ونبيه يظهر في الاجراءات نحط هذا السطر فقط عشان ما يصير زحمة في التيبل اكشن
                        IsEdit = true,
