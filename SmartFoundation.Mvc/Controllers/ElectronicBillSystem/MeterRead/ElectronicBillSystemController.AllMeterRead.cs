                ...
                ["visibleFields"] = new List<string>
    {
        "meterServiceTypeName_A","meterNo","LastRead", "CurrentRead","ReadDiff", "TotalPrice"
            ...
            var dsModel = new SmartTableDsModel
            {
                ...
                RenderAsTab = true,
                TabGroupKey = "all-meter-read-page",
                TabKey = "reading-periods",
                TabLabel = "فترات القراءة",
            ...
            var dsModelELECTRICITYMETER = new SmartTableDsModel
            {
                ...
                RenderAsTab = true,
                TabGroupKey = "all-meter-read-page",
                TabKey = "electricity-meter-readings",
                TabLabel = "قراءة العدادات",
                TabIcon = "fa-solid fa-gauge",
