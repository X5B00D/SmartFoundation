        ...
        public async Task<IActionResult> HousingExtend(int pdf = 0)
        {
                    ...
                    if (dt1 != null && dt1.Columns.Count > 0)
                    {
                        ...
                        foreach (DataColumn c in dt1.Columns)
                        {
                            ...
                            dynamicColumns.Add(new TableColumn
                            {
                                ...
                                || isresidentInfoID_FK || isIdaraId   || isAssignPeriodID || isbuildingDetailsID || isLastActionID  || isWaitingOrderTypeName || isWaitingListOrder)
                            });
                        }
            ...
            var dsModel = new SmartTableDsModel
            {
                ...
                Toolbar = new TableToolbarConfig
                {
                    ...
                    ShowDelete2 = canSENDHOUSINGEXTENDTOFINANCE,
                    ...
                    Delete2 = new TableAction  // ✅ لازم تحدد Edit1 بدل Delete1!
                    {
                            ...
                            DisableWhenAny = new List<TableActionRule>
                        {
                              ...
                              new TableActionRule
                            {
                                ...
                                Op = "neq",
                                Value = "500",
                                Message = "لايمكن الاعتماد باقي ماخلص الطلب",
                                Priority = 3
                            },
                          }
                        }
