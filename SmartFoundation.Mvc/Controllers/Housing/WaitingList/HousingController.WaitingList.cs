    ...
    public partial class HousingController : Controller
    {
        public async Task<IActionResult> WaitingList()
        {
            ...
            result = await _CrudController.GetDDLValues(
                "rankNameA", "rankID", "2", nameof(WaitingList), usersId, IdaraId, HostName
           ) as JsonResult;
            ...
            //// ---------------------- militaryUnitOptions ----------------------
            result = await _CrudController.GetDDLValues(
                "militaryUnitName_A", "militaryUnitID", "3", nameof(WaitingList), usersId, IdaraId, HostName
           ) as JsonResult;
            ...
            //// ---------------------- MaritalStatus ----------------------
            result = await _CrudController.GetDDLValues(
                "maritalStatusName_A", "maritalStatusID", "4", nameof(WaitingList), usersId, IdaraId, HostName
           ) as JsonResult;
            ...
            //// ---------------------- Nationality ----------------------
            result = await _CrudController.GetDDLValues(
                "nationalityName_A", "nationalityID", "5", nameof(WaitingList), usersId, IdaraId, HostName
           ) as JsonResult;
            ...
            //// ---------------------- Gender ----------------------
            result = await _CrudController.GetDDLValues(
                "genderName_A", "genderID", "6", nameof(WaitingList), usersId, IdaraId, HostName
           ) as JsonResult;
