...
namespace SmartFoundation.Mvc.Controllers.Housing
{
    public partial class HousingController : Controller
    {
        public async Task<IActionResult> MilitaryLocation()
        {
            ...
            string rowIdField = "";
            bool canInsertMILITARYLOCATION = false;
            bool canUpdateMILITARYLOCATION = false;
            bool canDeleteMILITARYLOCATION = false;
            ...
            try
            {
                if (ds != null && ds.Tables.Count > 0 && permissionTable!.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow row in permissionTable.Rows)
                    {
                        ...
                        if (permissionName == "INSERTMILITARYLOCATION") canInsertMILITARYLOCATION = true;
                        if (permissionName == "UPDATEMILITARYLOCATION") canUpdateMILITARYLOCATION = true;
                        if (permissionName == "DELETEMILITARYLOCATION") canDeleteMILITARYLOCATION = true;
                    }
            ...
            addFields.Insert(0, new FieldConfig { Name = "ActionType", Type = "hidden", Value = "INSERTMILITARYLOCATION" });
            ...
            var updateFields = new List<FieldConfig>
            {
                ...
                new FieldConfig { Name = "ActionType",          Type = "hidden", Value = "UPDATEMILITARYLOCATION" },
            ...
            var deleteFields = new List<FieldConfig>
            {
                ...
                new FieldConfig { Name = "redirectController", Type = "hidden", Value = ControllerName },
                new FieldConfig { Name = "pageName_",          Type = "hidden", Value = PageName },
                new FieldConfig { Name = "ActionType",         Type = "hidden", Value = "DELETEMILITARYLOCATION" },
                new FieldConfig { Name = "__RequestVerificationToken", Type = "hidden", Value = (Request.Headers["RequestVerificationToken"].FirstOrDefault() ?? "") },
                new FieldConfig { Name = rowIdField, Type = "hidden" },
            ...
            var dsModel = new SmartFoundation.UI.ViewModels.SmartTable.SmartTableDsModel
            {
                ...
                Toolbar = new TableToolbarConfig
                {
                    ...
                    ShowAdd = canInsertMILITARYLOCATION,
                    ShowEdit = canUpdateMILITARYLOCATION,
                    ShowDelete = canDeleteMILITARYLOCATION,
