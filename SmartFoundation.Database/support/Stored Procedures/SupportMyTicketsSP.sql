CREATE PROCEDURE [support].[SupportMyTicketsSP]
(
      @Action             NVARCHAR(200)
...
BEGIN
    ...
    BEGIN TRY
        ...
        (
            ...
            @entryUserID, @entryData, @hostName
        );
        ...
        VALUES (N'[support].[Ticket]', N'SMT_CREATE_TICKET', @newID, @entryData, @note);

        SELECT 1 AS IsSuccessful, N'تم إنشاء التذكرة بنجاح' AS Message_;
        RETURN;
    END TRY
    BEGIN CATCH
