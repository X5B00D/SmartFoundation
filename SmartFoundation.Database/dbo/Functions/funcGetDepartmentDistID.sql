...
BEGIN
    ...
    FROM DeptSecDiv DSD
    INNER JOIN KFMC.dbo.Distributor D ON DSD.DSDID = D.DSDID_FK
    INNER JOIN KFMC.dbo.DistributorType DT ON D.distributorType_FK = DT.distributorTypeID
    INNER JOIN KFMC.dbo.Department Dep ON Dep.deptID = DSD.deptID_FK
