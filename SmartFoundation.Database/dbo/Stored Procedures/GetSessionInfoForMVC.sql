            ...
            BEGIN
                ...
                BEGIN
                    SELECT TOP(1)
                        ...
                        up.ChangedPassword,
                        (select top(1) o.OrganizationLogo from DATACORE.dbo.Organization o) AS OrganaiztionLogo,
                        (select top(1) i.idaraLogo from DATACORE.dbo.Idara i where i.idaraID = d.IdaraID) AS IdaraLogo
                    FROM dbo.[Users] u
