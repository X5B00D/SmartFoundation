...
/* =========================================================
   (F) TransferRequest_Cancel_SP  (تعطيل + History Cancelled)
========================================================= */
CREATE PROCEDURE [VIC].[TransferRequest_Cancel_SP]
(
      @requestID  INT
    , @actionBy   INT
    , @note       NVARCHAR(1000)
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT 1 AS IsSuccessful, N'تم إلغاء الطلب' AS Message_;
    END TRY
    BEGIN CATCH
