...
BEGIN
    ...
    BEGIN TRY
       ...
       IF(@Action IN('INSERTRESIDENTS','UPDATERESIDENTS'))
       BEGIN
       ...
       END
        ...
        -- UPDATE
        ----------------------------------------------------------------
        ELSE IF @Action = N'UPDATERESIDENTS'
        BEGIN
        ...
        -- DELETE (Soft Delete)
        ----------------------------------------------------------------
        ELSE IF @Action = N'DELETERESIDENTS'
        BEGIN
