...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            BEGIN
                ;THROW 50001, N'لايمكن تحديث خطاب تسكين جديد للمستفيد لوجود طلب نقل له الى ادارة اخرى', 1;
            END
        ...
        BEGIN
            ...
            BEGIN
                ;THROW 50001, N'لايمكن الغاء خطاب تسكين جديد للمستفيد لوجود طلب نقل له الى ادارة اخرى', 1;
            END
