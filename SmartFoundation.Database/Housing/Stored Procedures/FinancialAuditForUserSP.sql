...
CREATE PROCEDURE [Housing].[FinancialAuditForUserSP] 
(
      @Action                               NVARCHAR(200)
...
BEGIN
    ...
    BEGIN TRY
        ...
        ----------------------------------------------------------------
        IF @Action = N'FinancialAuditForUser'
        BEGIN
        ...
        ----------------------------------------------------------------
        ELSE IF @Action = N'PAYMENTANDREFUNDFORUSER'
        BEGIN
        ...
        -- FINANCIALSETTLEMENT
        ----------------------------------------------------------------
        ELSE IF @Action = N'FINANCIALSETTLEMENTFORUSER'
        BEGIN
