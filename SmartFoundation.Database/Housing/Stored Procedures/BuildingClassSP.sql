...
BEGIN
    ...
    BEGIN TRY
        ...
        -- INSERT
        ----------------------------------------------------------------
        IF @Action = N'INSERTBUILDINGCLASS'
        BEGIN
            ...
            END
            INSERT INTO  Housing.BuildingClass
            (
                  buildingClassName_A
                , buildingClassName_E
        ...
        -- UPDATE
        ----------------------------------------------------------------
        ELSE IF @Action = N'UPDATEBUILDINGCLASS'
        BEGIN
        ...
        -- DELETE (Soft Delete)
        ----------------------------------------------------------------
        ELSE IF @Action = N'DELETEBUILDINGCLASS'
        BEGIN
            IF @buildingClassID IS NULL
            BEGIN
